...
public class CopyOfDictionary {
	 ...
	 * 词典单子实例
	 */
	private static final CopyOfDictionary singleton;

	/*
	 * 词典初始化
	 */
	static {
		singleton = new CopyOfDictionary();
	}
	...
	private void loadMainDict() {
		...
		// 读取主词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_MAIN);
		if (is == null) {
		...
		if (extDictFiles != null) {
			for (String extDictName : extDictFiles) {
				// 读取扩展词典文件
				is = CopyOfDictionary.class.getResourceAsStream(extDictName);
				// 如果找不到扩展的字典，则忽略
				if (is == null) {
					continue;
				}
	...
	private void loadSurnameDict() {
		...
		// 读取姓氏词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_SURNAME);
		if (is == null) {
	...
	private void loadQuantifierDict() {
		...
		// 读取量词词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_QUANTIFIER);
		if (is == null) {
	...
	private void loadSuffixDict() {
		...
		// 读取量词词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_SUFFIX);
		if (is == null) {
	...
	private void loadPrepDict() {
		...
		// 读取量词词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_PREP);
		if (is == null) {
	...
	private void loadStopWordDict() {
		...
		// 读取量词词典文件
		InputStream is = CopyOfDictionary.class
				.getResourceAsStream(CopyOfDictionary.PATH_DIC_STOP);
		if (is == null) {
		...
		if (extStopWordDictFiles != null) {
			for (String extStopWordDictName : extStopWordDictFiles) {
				// 读取扩展词典文件
				is = CopyOfDictionary.class.getResourceAsStream(extStopWordDictName);
				// 如果找不到扩展的字典，则忽略
				if (is == null) {
					continue;
				}
	 ...
	 * @return Dictionary
	 */
	public static CopyOfDictionary getInstance() {
		return CopyOfDictionary.singleton;
	}
